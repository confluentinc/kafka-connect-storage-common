...
public class DailyPartitionerTest extends StorageSinkTestBase {
  ...
  public void testDailyPartitioner() {
    ...
    int month = 2;
    int day = 1;
    long timestamp = new DateTime(year, month, day, 3, 0, 0, 0, DateTimeZone.forID(timeZoneString)).getMillis();
