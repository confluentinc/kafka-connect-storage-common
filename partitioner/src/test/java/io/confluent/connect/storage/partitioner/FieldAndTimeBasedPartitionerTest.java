...
public class FieldAndTimeBasedPartitionerTest extends StorageSinkTestBase {
    ...
    @Test
    public void testFieldAndTimeBasePartitioner() throws Exception {
        FieldAndTimeBasedPartitioner<String> partitioner = new FieldAndTimeBasedPartitioner<>();
        Map<String, Object> config = createConfig("timestamp", Optional.of("int"));
        partitioner.configure(config);
        ...
        assertEquals("int=12/year=2015/month=4/day=2/hour=1/", encodedPartition);
    }
    ...
    private static class BiHourlyPartitioner extends FieldAndTimeBasedPartitioner<String> {
    ...
    private Map<String, Object> createConfig(String timeFieldName) {
        return createConfig(timeFieldName,Optional.empty());
    }

    private Map<String, Object> createConfig(String timeFieldName, Optional<String> partitionField) {
        ...
        if (partitionField.isPresent()) {
            config.put(PartitionerConfig.PARTITION_FIELD_NAME_CONFIG, Collections.singletonList(partitionField.get()));
        }
