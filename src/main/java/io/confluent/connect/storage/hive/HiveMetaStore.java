...
public class HiveMetaStore {
  ...
  public HiveMetaStore(Configuration conf, StorageSinkConnectorConfig connectorConfig)
      throws HiveMetaStoreException {
    HiveConf hiveConf = new HiveConf(conf, HiveConf.class);
    String hiveConfDir = connectorConfig.getString(StorageSinkConnectorConfig.HIVE_CONF_DIR_CONFIG);
    String hiveMetaStoreURIs =
        connectorConfig.getString(StorageSinkConnectorConfig.HIVE_METASTORE_URIS_CONFIG);
