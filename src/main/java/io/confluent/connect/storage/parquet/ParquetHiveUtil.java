...
import io.confluent.connect.storage.FileUtils;
...
public class ParquetHiveUtil extends HiveUtil {
  ...
  public ParquetHiveUtil(StorageSinkConnectorConfig connectorConfig, AvroData avroData, HiveMetaStore hiveMetaStore) {
